...
SCENARIO_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data/scenarios')
ROBOTS_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'data/robots')
